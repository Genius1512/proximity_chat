...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/nerdcommenter,~/.vim/bundle/nerdtree,~/.vim/bundle/todo,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
...
silent only
silent tabonly
cd ~/github/genius1512/proximity_chat
...
wincmd w
argglobal
if bufexists("scripts/logger.py") | buffer scripts/logger.py | else | edit scripts/logger.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
terminal ++curwin ++cols=140 ++rows=11 
setlocal keymap=
setlocal noarabic
...
exe '3resize ' . ((&lines * 11 + 20) / 41)
tabnext 1
badd +1 scripts/__main__.py
badd +0 scripts/logger.py
